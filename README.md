...
- A complete wrapper for the  CUDA Driver API, version 8.0 prerelease (a 1:1 representation of cuda.h in C#) 
...
- Includes all CUDA libraries: CUFFT, CURAND, CUSPARSE, CUBLAS, CUSOLVE, NPP, NVGRAPH, Nvml and NVRTC 
