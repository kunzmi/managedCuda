...
namespace ManagedCuda.NvJitLink
{
    ...
    public static class NvJitLinkNativeMethods
    {
        ...
        internal static extern nvJitLinkResult __nvJitLinkCreate_12_4(
        ...
        public static nvJitLinkResult nvJitLinkCreate(ref nvJitLinkHandle handle, string[] options)
        {
            ...
            try
            {
                ...
                retVal = __nvJitLinkCreate_12_4(ref handle, numOptions, stringPtrs);
            }
            catch
            {
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkDestroy_12_4(ref nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkDestroy_12_4(ref handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddData_12_4(
        ...
        {
            return __nvJitLinkAddData_12_4(handle, inputType, data, data.Length, name);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddFile_12_4(nvJitLinkHandle handle,
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkComplete_12_4(nvJitLinkHandle handle);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_12_4(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedCubinSize_12_4(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubin_12_4(nvJitLinkHandle handle, byte[] cubin);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_12_4(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedPtxSize_12_4(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtx_12_4(nvJitLinkHandle handle, byte[] ptx);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLogSize_12_4(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetErrorLogSize_12_4(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLog_12_4(nvJitLinkHandle handle, byte[] log);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLogSize_12_4(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetInfoLogSize_12_4(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLog_12_4(nvJitLinkHandle handle, byte[] log);
