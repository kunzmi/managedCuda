...
namespace ManagedCuda.NvJitLink
{
    ...
    public static class NvJitLinkNativeMethods
    {
        ...
        internal static extern nvJitLinkResult __nvJitLinkCreate_12_0(
        ...
        public static nvJitLinkResult nvJitLinkCreate(ref nvJitLinkHandle handle, string[] options)
        {
            ...
            try
            {
                ...
                retVal = __nvJitLinkCreate_12_0(ref handle, numOptions, stringPtrs);
            }
            catch
            {
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkDestroy_12_0(ref nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkDestroy_12_0(ref handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddData_12_0(
        ...
        {
            return __nvJitLinkAddData_12_0(handle, inputType, data, data.Length, name);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddFile_12_0(nvJitLinkHandle handle,
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkComplete_12_0(nvJitLinkHandle handle);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_12_0(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedCubinSize_12_0(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubin_12_0(nvJitLinkHandle handle, byte[] cubin);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_12_0(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedPtxSize_12_0(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtx_12_0(nvJitLinkHandle handle, byte[] ptx);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLogSize_12_0(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetErrorLogSize_12_0(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLog_12_0(nvJitLinkHandle handle, byte[] log);
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLogSize_12_0(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetInfoLogSize_12_0(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLog_12_0(nvJitLinkHandle handle, byte[] log);
