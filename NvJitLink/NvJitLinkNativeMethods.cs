...
namespace ManagedCuda.NvJitLink
{
    ...
    public static class NvJitLinkNativeMethods
    {
        ...
        internal static extern nvJitLinkResult __nvJitLinkCreate_12_1(
        ...
        /// - -arch=sm_&lt;N&gt;<para/>
        /// Pass SM architecture value. See nvcc for valid values of &lt;N&gt;. This is a required option.<para/>
        /// - -maxrregcount=&lt;N&gt;<para/>
        ...
        public static nvJitLinkResult nvJitLinkCreate(ref nvJitLinkHandle handle, string[] options)
        {
            ...
            try
            {
                ...
                retVal = __nvJitLinkCreate_12_1(ref handle, numOptions, stringPtrs);
            }
            catch
            {
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkDestroy_12_1(ref nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkDestroy_12_1(ref handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddData_12_1(
        ...
        {
            return __nvJitLinkAddData_12_1(handle, inputType, data, size, name);
        }
        /// <summary>
        /// nvJitLinkAddData adds data image to the link. 
        /// </summary>
        ...
        {
            return __nvJitLinkAddData_12_1(handle, inputType, data, data.Length, name);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddFile_12_1(nvJitLinkHandle handle,
        ...
        {
            return __nvJitLinkAddFile_12_1(handle, inputType, fileName);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkComplete_12_1(nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkComplete_12_1(handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_12_1(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedCubinSize_12_1(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubin_12_1(nvJitLinkHandle handle, byte[] cubin);
        ...
        {
            return __nvJitLinkGetLinkedCubin_12_1(handle, cubin);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_12_1(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedPtxSize_12_1(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtx_12_1(nvJitLinkHandle handle, byte[] ptx);
        ...
        {
            return __nvJitLinkGetLinkedPtx_12_1(handle, ptx);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLogSize_12_1(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetErrorLogSize_12_1(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLog_12_1(nvJitLinkHandle handle, byte[] log);
        ...
        {
            return __nvJitLinkGetErrorLog_12_1(handle, log);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLogSize_12_1(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetInfoLogSize_12_1(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLog_12_1(nvJitLinkHandle handle, byte[] log);
        ...
        {
            return __nvJitLinkGetInfoLog_12_1(handle, log);
        }
