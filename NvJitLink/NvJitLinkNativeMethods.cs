...
namespace ManagedCuda.NvJitLink
{
    ...
    public static class NvJitLinkNativeMethods
    {
        ...
        internal static extern nvJitLinkResult __nvJitLinkCreate_12_8(
        ...
        public static nvJitLinkResult nvJitLinkCreate(ref nvJitLinkHandle handle, string[] options)
        {
            ...
            try
            {
                ...
                retVal = __nvJitLinkCreate_12_8(ref handle, numOptions, stringPtrs);
            }
            catch
            {
        ...
        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkDestroy_12_8(ref nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkDestroy_12_8(ref handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddData_12_8(
        ...
        {
            return __nvJitLinkAddData_12_8(handle, inputType, data, size, name);
        }
        /// <summary>
        /// nvJitLinkAddData adds data image to the link. 
        /// </summary>
        ...
        {
            return __nvJitLinkAddData_12_8(handle, inputType, data, data.Length, name);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkAddFile_12_8(nvJitLinkHandle handle,
        ...
        {
            return __nvJitLinkAddFile_12_8(handle, inputType, fileName);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkComplete_12_8(nvJitLinkHandle handle);
        ...
        {
            return __nvJitLinkComplete_12_8(handle);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubinSize_12_8(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedCubinSize_12_8(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedCubin_12_8(nvJitLinkHandle handle, byte[] cubin);
        ...
        {
            return __nvJitLinkGetLinkedCubin_12_8(handle, cubin);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtxSize_12_8(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetLinkedPtxSize_12_8(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetLinkedPtx_12_8(nvJitLinkHandle handle, byte[] ptx);
        ...
        {
            return __nvJitLinkGetLinkedPtx_12_8(handle, ptx);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLogSize_12_8(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetErrorLogSize_12_8(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetErrorLog_12_8(nvJitLinkHandle handle, byte[] log);
        ...
        {
            return __nvJitLinkGetErrorLog_12_8(handle, log);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLogSize_12_8(nvJitLinkHandle handle, ref SizeT size);
        ...
        {
            return __nvJitLinkGetInfoLogSize_12_8(handle, ref size);
        }

        [DllImport(NVJITLINK_API_DLL_NAME)]
        internal static extern nvJitLinkResult __nvJitLinkGetInfoLog_12_8(nvJitLinkHandle handle, byte[] log);
        ...
        {
            return __nvJitLinkGetInfoLog_12_8(handle, log);
        }
