...
namespace ManagedCuda
{
    ...
    /// </summary>
    public class CudaOpenGLImageInteropResource : ICudaGraphicsInteropResource
    {
        /// <summary>
        ...
        private OpenGLImageTarget _target;
        ...
        public CudaOpenGLImageInteropResource(uint resource, CUGraphicsRegisterFlags flags, OpenGLImageTarget target)
        {
            ...
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cuGraphicsGLRegisterImage", res));
