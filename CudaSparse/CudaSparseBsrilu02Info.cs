...
namespace ManagedCuda.CudaSparse
{
	...
	/// </summary>
	public class CudaSparseBsrilu02Info : IDisposable
	{
		private bsrilu02Info _info;
		...
		protected virtual void Dispose(bool fDisposing)
		{
			...
			{
				//Ignore if failing
				res = CudaSparseNativeMethods.cusparseDestroyBsrilu02Info(_info);
				Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "cusparseDestroyBsrilu02Info", res));
				disposed = true;
			}
			if (!fDisposing && !disposed)
		...
		/// </summary>
		public bsrilu02Info Bsrilu02Info
		{
			get { return _info; }
		}
	}
