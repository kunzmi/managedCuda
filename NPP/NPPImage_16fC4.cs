...
namespace ManagedCuda.NPP
{
	...
	public partial class NPPImage_16fC4 : NPPImageBase
	{
		...
		{
			status = NPPNativeMethods.NPPi.ColorTwist.nppiColorTwist32f_16f_C4R(_devPtr, _pitch, dest.DevicePointer, dest.Pitch, _sizeRoi, twistMatrix);
		...
		{
			status = NPPNativeMethods.NPPi.ColorTwist.nppiColorTwist32f_16f_C4IR(_devPtr, _pitch, _sizeRoi, aTwist);
		...
		{
			status = NPPNativeMethods.NPPi.ColorTwist.nppiColorTwist32fC_16f_C4R(_devPtr, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, twistMatrix, aConstants);
		...
		{
			status = NPPNativeMethods.NPPi.ColorTwist.nppiColorTwist32fC_16f_C4IR(_devPtr, _pitch, _sizeRoi, twistMatrix, aConstants);
		...
		public void Resize(NPPImage_16fC4 dest, InterpolationMode eInterpolation)
		{
			status = NPPNativeMethods.NPPi.GeometricTransforms.nppiResize_16f_C4R(_devPtr, _pitch, _sizeOriginal, new NppiRect(_pointRoi, _sizeRoi), dest.DevicePointer, dest.Pitch, dest.Size, new NppiRect(dest.PointRoi, dest.SizeRoi), eInterpolation);
			Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiResize_16f_C4R", status));
			NPPException.CheckNppStatus(status, this);
		}
		...
		public void WarpAffine(NPPImage_16fC4 dest, double[,] coeffs, InterpolationMode eInterpolation)
		{
			NppiRect rectIn = new NppiRect(_pointRoi, _sizeRoi);
			NppiRect rectOut = new NppiRect(dest.PointRoi, dest.SizeRoi);
			status = NPPNativeMethods.NPPi.AffinTransforms.nppiWarpAffine_16f_C4R(_devPtr, _sizeOriginal, _pitch, rectIn, dest.DevicePointer, dest.Pitch, rectOut, coeffs, eInterpolation);
			Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWarpAffine_16f_C4R", status));
			NPPException.CheckNppStatus(status, this);
		}
		...
		{
			NppStatus status = NPPNativeMethods.NPPi.GeometricTransforms.nppiWarpAffineBatch_16f_C4R(oSmallestSrcSize, oSrcRectROI, oDstRectROI, eInterpolation, pBatchList.DevicePointer, pBatchList.Size);
			Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWarpAffineBatch_16f_C4R", status));
			NPPException.CheckNppStatus(status, null);
		}
		...
		/// <param name="eInterpolation">Interpolation mode: can be <see cref="InterpolationMode.NearestNeighbor"/>, <see cref="InterpolationMode.Linear"/> or <see cref="InterpolationMode.Cubic"/></param>
		public void WarpPerspective(NPPImage_16fC4 dest, double[,] coeffs, InterpolationMode eInterpolation)
		{
			NppiRect rectIn = new NppiRect(_pointRoi, _sizeRoi);
			NppiRect rectOut = new NppiRect(dest.PointRoi, dest.SizeRoi);
			status = NPPNativeMethods.NPPi.PerspectiveTransforms.nppiWarpPerspective_16f_C4R(_devPtr, _sizeOriginal, _pitch, rectIn, dest.DevicePointer, dest.Pitch, rectOut, coeffs, eInterpolation);
			Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWarpPerspective_16f_C4R", status));
			NPPException.CheckNppStatus(status, this);
		}
