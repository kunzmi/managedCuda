...
namespace ManagedCuda.NPP
{
	...
	/// 
	/// </summary>
	public class NPPImage_16uC1 : NPPImageBase
	{
		#region Constructors
		/// <summary>
		...
		{
			status = NPPNativeMethods.NPPi.FilterGaussPyramid.nppiFilterGaussPyramidLayerUpBorder_16u_C1R(_devPtr, _pitch, _sizeOriginal, _pointRoi, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nRate, nFilterTaps, pKernel.DevicePointer, eBorderType);
