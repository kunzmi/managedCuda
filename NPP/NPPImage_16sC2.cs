...
namespace ManagedCuda.NPP
{
    ...
    public partial class NPPImage_16sC2 : NPPImageBase
    {
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist32f_16s_C2R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, twistMatrix);
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist32f_16s_C2IR(_devPtrRoi, _pitch, _sizeRoi, aTwist);
