...
namespace ManagedCuda.NPP
{
    ...
    public partial class NPPImage_32sC3 : NPPImageBase
    {
        ...
        public NPPImage_32sC3(int nWidthPixels, int nHeightPixels)
        {
            ...
            _dataType = NppDataType.NPP_32S;
            _nppChannels = NppiChannels.NPP_CH_3;

            _devPtr = NPPNativeMethods.NPPi.MemAlloc.nppiMalloc_32s_C3(nWidthPixels, nHeightPixels, ref _pitch);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}, Pitch is: {3}, Number of color channels: {4}", DateTime.Now, "nppiMalloc_32s_C3", res, _pitch, _channels));
        ...
        /// </summary>
        public CudaPitchedDeviceVariable<VectorTypes.int3> ToCudaPitchedDeviceVariable()
        {
            return new CudaPitchedDeviceVariable<VectorTypes.int3>(_devPtr, _sizeOriginal.width, _sizeOriginal.height, _pitch);
        }
        ...
        public static implicit operator CudaPitchedDeviceVariable<VectorTypes.int3>(NPPImage_32sC3 img)
        {
        ...
        public static implicit operator NPPImage_32sC3(CudaPitchedDeviceVariable<VectorTypes.int3> img)
        {
        ...
        public void Copy(NPPImage_32sC1 dst, int channel)
        {
            ...
            status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_C3C1R(_devPtrRoi + channel * _typeSize, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_C3C1R", status));
        ...
        public void Copy(NPPImage_32sC1 dst0, NPPImage_32sC1 dst1, NPPImage_32sC1 dst2)
        {
            ...
            status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_C3P3R(_devPtrRoi, _pitch, array, dst0.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_C3P3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        public static void Copy(NPPImage_32sC1 src0, NPPImage_32sC1 src1, NPPImage_32sC1 src2, NPPImage_32sC3 dest)
        {
            ...
            NppStatus status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_P3C3R(array, src0.Pitch, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_P3C3R", status));
        ...
        public void Copy(NPPImage_32sC3 dst, int channelSrc, int channelDst)
        {
            ...
            status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_C3CR(_devPtrRoi + channelSrc * _typeSize, _pitch, dst.DevicePointerRoi + channelDst * _typeSize, dst.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_C3CR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_C3MR(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi, mask.DevicePointerRoi, mask.Pitch);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_C3MR", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.BitDepthConversion.nppiConvert_32s8u_C3R(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiConvert_32s8u_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.LeftShiftConst.nppiLShiftC_32s_C3R(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiLShiftC_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.LeftShiftConst.nppiLShiftC_32s_C3IR(nConstant, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiLShiftC_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.RightShiftConst.nppiRShiftC_32s_C3R(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiRShiftC_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.RightShiftConst.nppiRShiftC_32s_C3IR(nConstant, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiRShiftC_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.And.nppiAnd_32s_C3R(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAnd_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.And.nppiAnd_32s_C3IR(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAnd_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.AndConst.nppiAndC_32s_C3IR(nConstant, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAndC_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.Or.nppiOr_32s_C3R(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiOr_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.Or.nppiOr_32s_C3IR(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiOr_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.OrConst.nppiOrC_32s_C3IR(nConstant, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiOrC_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.Xor.nppiXor_32s_C3R(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiXor_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.Xor.nppiXor_32s_C3IR(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiXor_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.XorConst.nppiXorC_32s_C3IR(nConstant, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiXorC_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Add.nppiAdd_32s_C3RSfs(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
        ...
        {
            status = NPPNativeMethods.NPPi.Add.nppiAdd_32s_C3IRSfs(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAdd_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.AddConst.nppiAddC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.AddConst.nppiAddC_32s_C3IRSfs(nConstant, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Sub.nppiSub_32s_C3RSfs(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSub_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.Sub.nppiSub_32s_C3IRSfs(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSub_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.SubConst.nppiSubC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.SubConst.nppiSubC_32s_C3IRSfs(nConstant, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Mul.nppiMul_32s_C3RSfs(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMul_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.Mul.nppiMul_32s_C3IRSfs(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMul_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.MulConst.nppiMulC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.MulConst.nppiMulC_32s_C3IRSfs(nConstant, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Div.nppiDiv_32s_C3RSfs(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDiv_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.Div.nppiDiv_32s_C3IRSfs(src2.DevicePointerRoi, src2.Pitch, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDiv_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.DivConst.nppiDivC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.DivConst.nppiDivC_32s_C3IRSfs(nConstant, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.GeometricTransforms.nppiMirror_32s_C3R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi, flip);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMirror_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.DotProd.nppiDotProdGetBufferHostSize_32s64f_C3R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDotProdGetBufferHostSize_32s64f_C3R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        public void DotProduct(NPPImage_32sC3 src2, CudaDeviceVariable<double> pDp, CudaDeviceVariable<byte> buffer)
        {
            ...
            status = NPPNativeMethods.NPPi.DotProd.nppiDotProd_32s64f_C3R(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, _sizeRoi, pDp.DevicePointer, buffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDotProd_32s64f_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.MemSet.nppiSet_32s_C3R(nValue, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSet_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.MemSet.nppiSet_32s_C3MR(nValue, _devPtrRoi, _pitch, _sizeRoi, mask.DevicePointerRoi, mask.Pitch);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSet_32s_C3MR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            if (channel < 0 | channel >= _channels) throw new ArgumentOutOfRangeException("channel", "channel must be in range [0..2].");
            status = NPPNativeMethods.NPPi.MemSet.nppiSet_32s_C3CR(nValue, _devPtrRoi + channel * _typeSize, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSet_32s_C3CR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.MemCopy.nppiCopy_32s_C3R(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopy_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.CopyConstBorder.nppiCopyConstBorder_32s_C3R(_devPtrRoi, _pitch, _sizeRoi, dst.DevicePointerRoi, dst.Pitch, dst.SizeRoi, nTopBorderHeight, nLeftBorderWidth, nValue);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopyConstBorder_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.CopyReplicateBorder.nppiCopyReplicateBorder_32s_C3R(_devPtrRoi, _pitch, _sizeRoi, dst.DevicePointerRoi, dst.Pitch, dst.SizeRoi, nTopBorderHeight, nLeftBorderWidth);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopyReplicateBorder_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.CopyWrapBorder.nppiCopyWrapBorder_32s_C3R(_devPtrRoi, _pitch, _sizeRoi, dst.DevicePointerRoi, dst.Pitch, dst.SizeRoi, nTopBorderHeight, nLeftBorderWidth);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopyWrapBorder_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        {
            status = NPPNativeMethods.NPPi.CopySubpix.nppiCopySubpix_32s_C3R(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi, nDx, nDy);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCopySubpix_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Convolution.nppiFilter32f_32s_C3R(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi, pKernel.DevicePointer, oKernelSize, oAnchor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilter32f_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        public void Scale(NPPImage_8uC3 dst, NppHintAlgorithm hint)
        {
            ...
            status = NPPNativeMethods.NPPi.Scale.nppiScale_32s8u_C3R(_devPtrRoi, _pitch, dst.DevicePointerRoi, dst.Pitch, _sizeRoi, hint);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiScale_32s8u_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.Transpose.nppiTranspose_32s_C3R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiTranspose_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        {
            status = NPPNativeMethods.NPPi.GeometricTransforms.nppiMirror_32s_C3IR(_devPtrRoi, _pitch, _sizeRoi, flip);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMirror_32s_C3IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        public void FilterBorder(NPPImage_32sC3 dest, CudaDeviceVariable<float> pKernel, NppiSize nKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, NppiRect filterArea = new NppiRect())
        {
            if (filterArea.Size == new NppiSize())
            {
                filterArea.Size = _sizeRoi;
            }
            status = NPPNativeMethods.NPPi.FilterBorder32f.nppiFilterBorder32f_32s_C3R(_devPtrRoi, _pitch, filterArea.Size, filterArea.Location, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi, pKernel.DevicePointer, nKernelSize, oAnchor, eBorderType);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterBorder32f_32s_C3R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Add(CudaDeviceVariable<int> nConstant, NPPImage_32sC3 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.AddDeviceConst.nppiAddDeviceC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddDeviceC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Add constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        /// <param name="nConstant">Value to add</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Add(CudaDeviceVariable<int> nConstant, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.AddDeviceConst.nppiAddDeviceC_32s_C3IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddDeviceC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        #region Sub
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Sub(CudaDeviceVariable<int> nConstant, NPPImage_32sC3 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.SubDeviceConst.nppiSubDeviceC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubDeviceC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Subtract constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        /// <param name="nConstant">Value to subtract</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Sub(CudaDeviceVariable<int> nConstant, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.SubDeviceConst.nppiSubDeviceC_32s_C3IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubDeviceC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Mul(CudaDeviceVariable<int> nConstant, NPPImage_32sC3 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.MulDeviceConst.nppiMulDeviceC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Multiply constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        /// <param name="nConstant">Value</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Mul(CudaDeviceVariable<int> nConstant, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.MulDeviceConst.nppiMulDeviceC_32s_C3IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Div(CudaDeviceVariable<int> nConstant, NPPImage_32sC3 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.DivDeviceConst.nppiDivDeviceC_32s_C3RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivDeviceC_32s_C3RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Divide constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        /// <param name="nConstant">Value</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Div(CudaDeviceVariable<int> nConstant, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.DivDeviceConst.nppiDivDeviceC_32s_C3IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivDeviceC_32s_C3IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
#endif
