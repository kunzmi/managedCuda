...
namespace ManagedCuda.NPP
{
	...
	public partial class NPPImage_32fC2 : NPPImageBase
    {
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist_32f_C2R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, twistMatrix);
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist_32f_C2IR(_devPtrRoi, _pitch, _sizeRoi, aTwist);
        ...
        public void FilterBorder(NPPImage_32fC2 dest, CudaDeviceVariable<float> pKernel, NppiSize nKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, NppiRect filterArea = new NppiRect())
        {
            if (filterArea.Size == new NppiSize())
            {
                filterArea.Size = _sizeRoi;
            }
            status = NPPNativeMethods.NPPi.FilterBorder.nppiFilterBorder_32f_C2R(_devPtrRoi, _pitch, filterArea.Size, filterArea.Location, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi, pKernel.DevicePointer, nKernelSize, oAnchor, eBorderType);
