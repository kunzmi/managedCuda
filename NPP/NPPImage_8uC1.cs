...
namespace ManagedCuda.NPP
{
    ...
    public partial class NPPImage_8uC1 : NPPImageBase
    {
        ...
        public void And(byte nConstant, NPPImage_8uC1 dest)
        {
            ...
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAndC_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        public void Or(byte nConstant, NPPImage_8uC1 dest)
        {
            ...
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiOrC_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        public void Xor(byte nConstant, NPPImage_8uC1 dest)
        {
            ...
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiXorC_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        ...
        public SizeT QualityIndexGetBufferHostSize()
        {
            ...
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiQualityIndexGetBufferHostSize_8u32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        {
            SizeT bufferSize = ResizeAdvancedGetBufferHostSize(dst.SizeRoi, eInterpolationMode);
            CudaDeviceVariable<byte> buffer = new CudaDeviceVariable<byte>(bufferSize);
        ...
        {
            int bufferSize = 0;
            status = NPPNativeMethods.NPPi.FilterCannyBorder.nppiFilterCannyBorderGetBufferSize(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterCannyBorderGetBufferSize", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        {
            int bufferSize = 0;
            status = NPPNativeMethods.NPPi.FilterHarrisCornersBorder.nppiFilterHarrisCornersBorderGetBufferSize(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterHarrisCornersBorderGetBufferSize", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        public void WMSSSIM(NPPImage_8uC1 src2, CudaDeviceVariable<float> pMSSSIM, CudaDeviceVariable<byte> pDeviceBuffer)
        {
            status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIM_8u_C1R(_devPtrRoi, _pitch, src2.DevicePointerRoi, src2.Pitch, _sizeRoi, pMSSSIM.DevicePointer, pDeviceBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWMSSSIM_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiMSEGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiPSNRGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiSSIMGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
        ...
        /// </summary>
        public SizeT MSSSIMGetBufferHostSize()
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiMSSSIMGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWMSSSIMGetBufferHostSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.GeometricTransforms.nppiResizeBatch_8u_C1R(oSmallestSrcSize, oSrcRectROI, oSmallestDstSize, oDstRectROI, eInterpolation, pBatchList.DevicePointer, pBatchList.Size);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiResizeBatch_8u_C1R", status));
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.GeometricTransforms.nppiResizeBatch_8u_C1R_Advanced(nMaxWidth, nMaxHeight, pBatchSrc.DevicePointer, pBatchDst.DevicePointer,
                pBatchROI.DevicePointer, pBatchDst.Size, eInterpolation);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiResizeBatch_8u_C1R_Advanced", status));
            NPPException.CheckNppStatus(status, null);
        }
        #endregion
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.GeometricTransforms.nppiWarpAffineBatch_8u_C1R(oSmallestSrcSize, oSrcRectROI, oDstRectROI, eInterpolation, pBatchList.DevicePointer, pBatchList.Size);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWarpAffineBatch_8u_C1R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.GeometricTransforms.nppiWarpPerspectiveBatch_8u_C1R(oSmallestSrcSize, oSrcRectROI, oDstRectROI, eInterpolation, pBatchList.DevicePointer, pBatchList.Size);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWarpPerspectiveBatch_8u_C1R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        {
            status = NPPNativeMethods.NPPi.LabelMarkers.nppiLabelMarkersUF_8u32u_C1R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, eNorm, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiLabelMarkersUF_8u32u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.ColorTwistBatch.nppiColorTwistBatch32f_8u_C1R(nMin, nMax, oSizeROI, pBatchList.DevicePointer, pBatchList.Size);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiColorTwistBatch32f_8u_C1R", status));
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.ColorTwistBatch.nppiColorTwistBatch32f_8u_C1IR(nMin, nMax, oSizeROI, pBatchList.DevicePointer, pBatchList.Size);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiColorTwistBatch32f_8u_C1IR", status));
            NPPException.CheckNppStatus(status, pBatchList);
        }
        #endregion
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.LabelMarkers.nppiLabelMarkersUFBatch_8u32u_C1R(pSrcBatchList.DevicePointer, pDstBatchList.DevicePointer, pSrcBatchList.Size, oSizeROI, eNorm);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiLabelMarkersUFBatch_8u32u_C1R", status));
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.LabelMarkers.nppiLabelMarkersUFBatch_8u32u_C1R_Advanced(pSrcBatchList.DevicePointer, pDstBatchList.DevicePointer, pSrcBatchList.Size, oMaxSizeROI, eNorm);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiLabelMarkersUFBatch_8u32u_C1R_Advanced", status));
            NPPException.CheckNppStatus(status, pSrcBatchList);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.WatershedSegmentation.nppiSegmentWatershedGetBufferSize_8u_C1R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSegmentWatershedGetBufferSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        public void SegmentWatershed(NPPImage_32uC1 pMarkerLabels, NppiNorm eNorm, NppiWatershedSegmentBoundaryType eSegmentBoundaryType, CudaDeviceVariable<byte> pBuffer)
        {
            ...
            status = NPPNativeMethods.NPPi.WatershedSegmentation.nppiSegmentWatershed_8u_C1IR(_devPtrRoi, _pitch, ptrMarker, markerPitch, eNorm, eSegmentBoundaryType, _sizeRoi, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSegmentWatershed_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFill(NppiPoint oSeed, byte nNewValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFill_8u_C1IR(_devPtrRoi, _pitch, oSeed, nNewValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFill_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFill(NppiPoint oSeed, byte nNewValue, byte nBoundaryValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFillBoundary_8u_C1IR(_devPtrRoi, _pitch, oSeed, nNewValue, nBoundaryValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFillBoundary_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
            return pConnectedRegion;
        }
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFill(NppiPoint oSeed, byte nMin, byte nMax, byte nNewValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFillRange_8u_C1IR(_devPtrRoi, _pitch, oSeed, nMin, nMax, nNewValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFillRange_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
            return pConnectedRegion;
        }
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFill(NppiPoint oSeed, byte nMin, byte nMax, byte nNewValue, byte nBoundaryValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFillRangeBoundary_8u_C1IR(_devPtrRoi, _pitch, oSeed, nMin, nMax, nNewValue, nBoundaryValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFillRangeBoundary_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
            return pConnectedRegion;
        }
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFillGradient(NppiPoint oSeed, byte nMin, byte nMax, byte nNewValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFillGradient_8u_C1IR(_devPtrRoi, _pitch, oSeed, nMin, nMax, nNewValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFillGradient_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
            return pConnectedRegion;
        }
        /// <summary>
        ...
        /// <param name="eNorm">Type of pixel connectivity test to use, nppiNormInf will use 8 way connectivity and nppiNormL1 will use 4 way connectivity. </param>
        /// <param name="pBuffer">Pointer to device memory scratch buffer at least as large as value returned by the corresponding LabelMarkersUFGetBufferSize call.</param>
        public NppiConnectedRegion FloodFillGradient(NppiPoint oSeed, byte nMin, byte nMax, byte nNewValue, byte nBoundaryValue, NppiNorm eNorm, CudaDeviceVariable<byte> pBuffer)
        {
            NppiConnectedRegion pConnectedRegion = new NppiConnectedRegion();
            status = NPPNativeMethods.NPPi.FloodFill.nppiFloodFillGradientBoundary_8u_C1IR(_devPtrRoi, _pitch, oSeed, nMin, nMax, nNewValue, nBoundaryValue, eNorm, _sizeRoi, ref pConnectedRegion, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFloodFillGradientBoundary_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
            return pConnectedRegion;
        }
                                                        ...
                                                        NPPImage_16sC1 pDstVoronoiManhattanDistances, NPPImage_16uC1 pDstTransform, CudaDeviceVariable<byte> pBuffer)
        {
            ...
            status = NPPNativeMethods.NPPi.FilterDistanceTransform.nppiDistanceTransformAbsPBA_8u16u_C1R(_devPtrRoi, _pitch, nMinSiteValue, nMaxSiteValue, dstVoronoi, pitchVoronoi, dstVoronoiIndices, pitchVoronoiIndices, dstVoronoiManhattenDistances, pitchVoronoiManhattenDistances, dstTransform, pitchTransform, _sizeRoi, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDistanceTransformAbsPBA_8u16u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
                                                  ...
                                                  NPPImage_16sC1 pDstVoronoiAbsoluteManhattanDistances, NPPImage_32fC1 pDstTransform, CudaDeviceVariable<byte> pBuffer)
        {
            ...
            status = NPPNativeMethods.NPPi.FilterDistanceTransform.nppiDistanceTransformAbsPBA_8u32f_C1R(_devPtrRoi, _pitch, nMinSiteValue, nMaxSiteValue, dstVoronoi, pitchVoronoi, dstVoronoiIndices, pitchVoronoiIndices, dstVoronoiManhattenDistances, pitchVoronoiManhattenDistances, dstTransform, pitchTransform, _sizeRoi, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDistanceTransformAbsPBA_8u32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
#endif
        #endregion
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Add(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.AddDeviceConst.nppiAddDeviceC_8u_C1RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddDeviceC_8u_C1RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Add constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        {
            status = NPPNativeMethods.NPPi.AddDeviceConst.nppiAddDeviceC_8u_C1IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAddDeviceC_8u_C1IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        #region Sub
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Sub(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.SubDeviceConst.nppiSubDeviceC_8u_C1RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubDeviceC_8u_C1RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Subtract constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        {
            status = NPPNativeMethods.NPPi.SubDeviceConst.nppiSubDeviceC_8u_C1IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiSubDeviceC_8u_C1IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Mul(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.MulDeviceConst.nppiMulDeviceC_8u_C1RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceC_8u_C1RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Multiply constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        {
            status = NPPNativeMethods.NPPi.MulDeviceConst.nppiMulDeviceC_8u_C1IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceC_8u_C1IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        /// <param name="nConstant">Value</param>
        /// <param name="dest">Destination image</param>
        public void Mul(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest)
        {
            status = NPPNativeMethods.NPPi.MulDeviceConstScale.nppiMulDeviceCScale_8u_C1R(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceCScale_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Multiply constant to image and scale by max bit width value
        ...
        {
            status = NPPNativeMethods.NPPi.MulDeviceConstScale.nppiMulDeviceCScale_8u_C1IR(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMulDeviceCScale_8u_C1IR", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        /// <param name="dest">Destination image</param>
        /// <param name="nScaleFactor">scaling factor</param>
        public void Div(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest, int nScaleFactor)
        {
            status = NPPNativeMethods.NPPi.DivDeviceConst.nppiDivDeviceC_8u_C1RSfs(_devPtrRoi, _pitch, nConstant.DevicePointer, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivDeviceC_8u_C1RSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// Divide constant to image, scale by 2^(-nScaleFactor), then clamp to saturated value. Inplace.
        ...
        {
            status = NPPNativeMethods.NPPi.DivDeviceConst.nppiDivDeviceC_8u_C1IRSfs(nConstant.DevicePointer, _devPtrRoi, _pitch, _sizeRoi, nScaleFactor);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDivDeviceC_8u_C1IRSfs", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
        ...
        /// <param name="nConstant">Value to subtract</param>
        /// <param name="dest">Destination image</param>
        public void AbsDiff(CudaDeviceVariable<byte> nConstant, NPPImage_8uC1 dest)
        {
            status = NPPNativeMethods.NPPi.AbsDiffDeviceConst.nppiAbsDiffDeviceC_8u_C1R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, nConstant.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiAbsDiffDeviceC_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        #endregion
#endif
        ...
        {
            uint bufferSize = 0;
            status = NPPNativeMethods.NPPi.ImageMedianFilter.nppiFilterMedianBorderGetBufferSize_8u_C1R(_sizeRoi, oMaskSize, ref bufferSize, eBorderType);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterMedianBorderGetBufferSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
                                                        ...
                                                        NPPImage_16sC1 pDstVoronoiManhattanRelativeDistances, NPPImage_64fC1 pDstTransform, CudaDeviceVariable<byte> pBuffer, CudaDeviceVariable<byte> pAntialiasingDeviceBuffer)
        {
            ...
            status = NPPNativeMethods.NPPi.FilterDistanceTransform.nppiDistanceTransformPBA_8u64f_C1R(_devPtrRoi, _pitch, nMinSiteValue, nMaxSiteValue, dstVoronoi, pitchVoronoi, dstVoronoiIndices, pitchVoronoiIndices, dstVoronoiManhattenDistances, pitchVoronoiManhattenDistances, dstTransform, pitchTransform, _sizeRoi, pBuffer.DevicePointer, antiAlias);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDistanceTransformPBA_8u64f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
                                                  ...
                                                  NPPImage_16sC1 pDstVoronoiAbsoluteManhattanDistances, NPPImage_64fC1 pDstTransform, CudaDeviceVariable<byte> pBuffer, CudaDeviceVariable<byte> pAntialiasingDeviceBuffer)
        {
            ...
            status = NPPNativeMethods.NPPi.FilterDistanceTransform.nppiDistanceTransformAbsPBA_8u64f_C1R(_devPtrRoi, _pitch, nMinSiteValue, nMaxSiteValue, dstVoronoi, pitchVoronoi, dstVoronoiIndices, pitchVoronoiIndices, dstVoronoiManhattenDistances, pitchVoronoiManhattenDistances, dstTransform, pitchTransform, _sizeRoi, pBuffer.DevicePointer, antiAlias);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiDistanceTransformAbsPBA_8u64f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        public void ContoursImageMarchingSquaresInterpolation(CudaPitchedDeviceVariable<NppiPoint32f> pContoursInterpolatedImageDev, CudaPitchedDeviceVariable<NppiContourPixelDirectionInfo> pContoursDirectionImageDev,
                                                               ...
                                                               CudaDeviceVariable<NppiContourBlockSegment> pContoursBlockSegmentListDev, NppiContourBlockSegment[] pContoursBlockSegmentListHost, NppiSize oSizeROI)
        {
            status = NPPNativeMethods.NPPi.LabelMarkers.nppiContoursImageMarchingSquaresInterpolation_32f_C1R(_devPtrRoi, _pitch, pContoursInterpolatedImageDev.DevicePointer, pContoursInterpolatedImageDev.Pitch,
                ...
                pContoursBlockSegmentListDev.DevicePointer, pContoursBlockSegmentListHost, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiContoursImageMarchingSquaresInterpolation_32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        public void ContoursImageMarchingSquaresInterpolation(CudaPitchedDeviceVariable<NppiPoint64f> pContoursInterpolatedImageDev, CudaPitchedDeviceVariable<NppiContourPixelDirectionInfo> pContoursDirectionImageDev,
                                                               ...
                                                               CudaDeviceVariable<NppiContourBlockSegment> pContoursBlockSegmentListDev, NppiContourBlockSegment[] pContoursBlockSegmentListHost, NppiSize oSizeROI)
        {
            status = NPPNativeMethods.NPPi.LabelMarkers.nppiContoursImageMarchingSquaresInterpolation_64f_C1R(_devPtrRoi, _pitch, pContoursInterpolatedImageDev.DevicePointer, pContoursInterpolatedImageDev.Pitch,
                pContoursDirectionImageDev.DevicePointer, pContoursDirectionImageDev.Pitch, pContoursPixelGeometryListsDev.DevicePointer, pContoursPixelGeometryListsHost, pContoursInterpolatedGeometryListsDev.DevicePointer,
                pContoursPixelsFoundListHost, pContoursPixelsStartingOffsetDev.DevicePointer, pContoursPixelsStartingOffsetHost, nTotalImagePixelContourCount, nMaxMarkerLabelID, nFirstContourGeometryListID, nLastContourGeometryListID,
                pContoursBlockSegmentListDev.DevicePointer, pContoursBlockSegmentListHost, _sizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiContoursImageMarchingSquaresInterpolation_64f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        /// <param name="filterArea">The area where the filter is allowed to read pixels. The point is relative to the ROI set to source image, the size is the total size starting from the filterArea point. Default value is the set ROI.</param>
        public void FilterMedianBorder(NPPImage_8uC1 dest, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, CudaDeviceVariable<byte> pBuffer, NppiRect filterArea = new NppiRect())
        {
            if (filterArea.Size == new NppiSize())
            {
                filterArea.Size = _sizeRoi;
            }
            status = NPPNativeMethods.NPPi.ImageMedianFilter.nppiFilterMedianBorder_8u_C1R(_devPtrRoi, _pitch, filterArea.Size, filterArea.Location, dest.DevicePointerRoi,
                                                    dest.Pitch, dest.SizeRoi, oMaskSize, oAnchor, pBuffer.DevicePointer, eBorderType);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterMedianBorder_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        /// <param name="pBuffer">Pointer to the user-allocated scratch buffer required for the Median operation.</param>
        /// <param name="filterArea">The area where the filter is allowed to read pixels. The point is relative to the ROI set to source image, the size is the total size starting from the filterArea point. Default value is the set ROI.</param>
        public void FilterBoxBorderAdvanced(NPPImage_8uC1 dest, NppiSize oMaskSize, NppiPoint oAnchor, NppiBorderType eBorderType, CudaDeviceVariable<byte> pBuffer, NppiRect filterArea = new NppiRect())
        {
            if (filterArea.Size == new NppiSize())
            {
                filterArea.Size = _sizeRoi;
            }
            status = NPPNativeMethods.NPPi.LinearFixedFilters2D.nppiFilterBoxBorderAdvanced_8u_C1R(_devPtrRoi, _pitch, filterArea.Size, filterArea.Location, dest.DevicePointerRoi,
                                                    dest.Pitch, dest.SizeRoi, oMaskSize, oAnchor, eBorderType, pBuffer.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiFilterBoxBorderAdvanced_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        ...
        public void CrossCorrFull_NormLevel(NPPImage_8uC1 tpl, NPPImage_32fC1 dst, CudaDeviceVariable<byte> buffer, CudaDeviceVariable<byte> bufferAdvanced)
        {
            status = NPPNativeMethods.NPPi.ImageProximity.nppiCrossCorrFull_NormLevelAdvanced_8u32f_C1R(_devPtrRoi, _pitch, _sizeRoi, tpl.DevicePointerRoi, tpl.Pitch, tpl.SizeRoi, dst.DevicePointer, dst.Pitch, buffer.DevicePointer, bufferAdvanced.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCrossCorrFull_NormLevelAdvanced_8u32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// CrossCorrSame_NormLevel.
        ...
        public void CrossCorrSame_NormLevel(NPPImage_8uC1 tpl, NPPImage_32fC1 dst, CudaDeviceVariable<byte> buffer, CudaDeviceVariable<byte> bufferAdvanced)
        {
            status = NPPNativeMethods.NPPi.ImageProximity.nppiCrossCorrSame_NormLevelAdvanced_8u32f_C1R(_devPtrRoi, _pitch, _sizeRoi, tpl.DevicePointerRoi, tpl.Pitch, tpl.SizeRoi, dst.DevicePointer, dst.Pitch, buffer.DevicePointer, bufferAdvanced.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCrossCorrSame_NormLevelAdvanced_8u32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
        /// <summary>
        /// CrossCorrValid_NormLevel.
        ...
        public void CrossCorrValid_NormLevel(NPPImage_8uC1 tpl, NPPImage_32fC1 dst, CudaDeviceVariable<byte> buffer, CudaDeviceVariable<byte> bufferAdvanced)
        {
            status = NPPNativeMethods.NPPi.ImageProximity.nppiCrossCorrValid_NormLevelAdvanced_8u32f_C1R(_devPtrRoi, _pitch, _sizeRoi, tpl.DevicePointerRoi, tpl.Pitch, tpl.SizeRoi, dst.DevicePointer, dst.Pitch, buffer.DevicePointer, bufferAdvanced.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiCrossCorrValid_NormLevelAdvanced_8u32f_C1R", status));
            NPPException.CheckNppStatus(status, this);
        }
#endif
        #endregion
        ...
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiMSEBatch_8u_C1R(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oSizeROI, pMSE.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMSEBatch_8u_C1R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        public static void MSEBatchAdvanced(NppiSize oMaxSizeROI, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc1, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc2, CudaDeviceVariable<float> pMSE,
                                        CudaDeviceVariable<NppiBufferDescriptor> pDeviceBufferList)
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiMSEBatch_8u_C1R_Advanced(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oMaxSizeROI, pMSE.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMSEBatch_8u_C1R_Advanced", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiMSEBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiMSEBatchGetBufferHostSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        public static void PSNRBatch(NppiSize oSizeROI, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc1, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc2, CudaDeviceVariable<float> pPSNR,
                                        CudaDeviceVariable<NppiBufferDescriptor> pDeviceBufferList)
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiPSNRBatch_8u_C1R(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oSizeROI, pPSNR.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiPSNRBatch_8u_C1R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        public static void PSNRBatchAdvanced(NppiSize oMaxSizeROI, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc1, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc2, CudaDeviceVariable<float> pPSNR,
                                        CudaDeviceVariable<NppiBufferDescriptor> pDeviceBufferList)
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiPSNRBatch_8u_C1R_Advanced(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oMaxSizeROI, pPSNR.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiPSNRBatch_8u_C1R_Advanced", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiPSNRBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiPSNRBatchGetBufferHostSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
        ...
        public static void WMSSSIMBatch(NppiSize oSizeROI, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc1, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc2, CudaDeviceVariable<float> pWMSSSIM,
                                        CudaDeviceVariable<NppiBufferDescriptor> pDeviceBufferList)
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMBatch_8u_C1R(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oSizeROI, pWMSSSIM.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWMSSSIMBatch_8u_C1R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        public static void WMSSSIMBatchAdvanced(NppiSize oMaxSizeROI, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc1, CudaDeviceVariable<NppiImageDescriptor> pBatchSrc2, CudaDeviceVariable<float> pWMSSSIM,
                                        CudaDeviceVariable<NppiBufferDescriptor> pDeviceBufferList)
        {
            NppStatus status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMBatch_8u_C1R_Advanced(pBatchSrc1.DevicePointer, pBatchSrc2.DevicePointer, pBatchSrc1.Size, oMaxSizeROI, pWMSSSIM.DevicePointer,
                pDeviceBufferList.DevicePointer);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWMSSSIMBatch_8u_C1R_Advanced", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        {
            SizeT bufferSize = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref bufferSize);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiWMSSSIMBatchGetBufferHostSize_8u_C1R", status));
            NPPException.CheckNppStatus(status, this);
            return bufferSize;
        }
    }
