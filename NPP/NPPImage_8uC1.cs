...
namespace ManagedCuda.NPP
{
    ...
    public partial class NPPImage_8uC1 : NPPImageBase
    {
        ...
        /// </summary>
        public int WMSSSIMGetBufferHostSize()
        {
            int ret = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMGetBufferHostSize_8u_C1R(_sizeRoi, ref ret);
        ...
        /// </summary>
        public int MSEBatchGetBufferHostSize()
        {
            int ret = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiMSEBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref ret);
        ...
        /// </summary>
        public int PSNRBatchGetBufferHostSize()
        {
            int ret = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiPSNRBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref ret);
        ...
        /// </summary>
        public int WMSSSIMBatchGetBufferHostSize()
        {
            int ret = 0;
            status = NPPNativeMethods.NPPi.IQA.nppiWMSSSIMBatchGetBufferHostSize_8u_C1R(_sizeRoi, ref ret);
