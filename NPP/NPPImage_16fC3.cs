...
namespace ManagedCuda.NPP
{
	...
	/// 
	/// </summary>
	public class NPPImage_16fC3 : NPPImageBase
	{
		#region Constructors
		/// <summary>
		...
		public void FilterBorder(NPPImage_16fC3 dest, CudaDeviceVariable<float> pKernel, NppiSize nKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType)
		{
			status = NPPNativeMethods.NPPi.FilterBorder32f.nppiFilterBorder32f_16f_C3R(_devPtr, _pitch, _sizeOriginal, _pointRoi, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi, pKernel.DevicePointer, nKernelSize, oAnchor, eBorderType);
