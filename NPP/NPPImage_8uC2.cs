...
namespace ManagedCuda.NPP
{
    ...
    public partial class NPPImage_8uC2 : NPPImageBase
    {
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist32f_8u_C2R(_devPtrRoi, _pitch, dest.DevicePointerRoi, dest.Pitch, _sizeRoi, twistMatrix);
        ...
        {
            status = NPPNativeMethods.NPPi.ColorProcessing.nppiColorTwist32f_8u_C2IR(_devPtrRoi, _pitch, _sizeRoi, aTwist);
        ...
        public void FilterBorder(NPPImage_8uC2 dest, CudaDeviceVariable<float> pKernel, NppiSize nKernelSize, NppiPoint oAnchor, NppiBorderType eBorderType, NppiRect filterArea = new NppiRect())
        {
            if (filterArea.Size == new NppiSize())
            {
                filterArea.Size = _sizeRoi;
            }
            status = NPPNativeMethods.NPPi.FilterBorder32f.nppiFilterBorder32f_8u_C2R(_devPtrRoi, _pitch, filterArea.Size, filterArea.Location, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi, pKernel.DevicePointer, nKernelSize, oAnchor, eBorderType);
        ...
        /// <param name="src1">Source image (Channel 1)</param>
        /// <param name="dest">Destination image</param>
        public static void NV12ToRGB_709CSC(NPPImage_8uC1 src0, NPPImage_8uC1 src1, NPPImage_8uC3 dest)
        {
            CUdeviceptr[] src = new CUdeviceptr[] { src0.DevicePointer, src1.DevicePointer };
            NppStatus status = NPPNativeMethods.NPPi.NV12ToRGB.nppiNV12ToRGB_709CSC_8u_P2C3R(src, src0.Pitch, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiNV12ToRGB_709CSC_8u_P2C3R", status));
            NPPException.CheckNppStatus(status, null);
        }
        ...
        /// <param name="src1">Source image (Channel 1)</param>
        /// <param name="dest">Destination image</param>
        public static void NV12ToBGR_709CSC(NPPImage_8uC1 src0, NPPImage_8uC1 src1, NPPImage_8uC3 dest)
        {
            CUdeviceptr[] src = new CUdeviceptr[] { src0.DevicePointer, src1.DevicePointer };
            NppStatus status = NPPNativeMethods.NPPi.NV12ToBGR.nppiNV12ToBGR_709CSC_8u_P2C3R(src, src0.Pitch, dest.DevicePointerRoi, dest.Pitch, dest.SizeRoi);
            Debug.WriteLine(String.Format("{0:G}, {1}: {2}", DateTime.Now, "nppiNV12ToBGR_709CSC_8u_P2C3R", status));
            NPPException.CheckNppStatus(status, null);
        }
        #endregion
    }
